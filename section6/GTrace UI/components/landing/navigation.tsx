...
const navLinks = [
  ...
  { name: "Audit & Security", href: "#security" },
      ...
      >
        ...
        >
          ...
          <a href="/" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl" : "text-2xl"}`}>GTrace</span>
            <span className={`text-muted-foreground font-mono transition-all duration-500 ${isScrolled ? "text-[10px] mt-0.5" : "text-xs mt-1"}`}>NCRB</span>
          </a>
      ...
      >
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            ...
            <Link href="/login">
              <Button
                className="flex-1 bg-foreground text-background rounded-full h-14 text-base w-full"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Request Access
              </Button>
