...
import { GraphStoreProvider } from "@/lib/investigation/data-store";
...
export const metadata: Metadata = {
  ...
  description: "Network analysis console for the GTrace criminal network analysis system.",
};
          ...
          <TooltipProvider delayDuration={200}>
            ...
            <Toaster
              ...
              toastOptions={{
                classNames: {
                  toast:
                    "!rounded-none !border-border !bg-popover !text-popover-foreground font-mono text-xs",
                },
              }}
            />
          </TooltipProvider>
